...
/**
 * An indexed collection of objects with non-null elements and allowed duplicates.
 * 
...
public class ArrayIndexedCollection<E> implements List<E> {
	...
	/**
	 * Returns an instance of an ElementsGetter for this array list.
	...
	private static class ArrayElementsGetter<E> implements ElementsGetter<E> {
		/**
		 * The index of the next object in the array to be delivered.
		 */
		private int index = 0;
		 ...
		 * @param col
		 */
		public ArrayElementsGetter(ArrayIndexedCollection<E> col) {
			this.col = col;
