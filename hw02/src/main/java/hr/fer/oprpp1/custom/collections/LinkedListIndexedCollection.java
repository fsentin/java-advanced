...
public class LinkedListIndexedCollection implements List {
	 ...
	 * @return index of the specified value if it exists inside the linked list, -1 if there is no such value.
	 */
	@Override
	...
	/**
	 * Returns an instance of an ElementsGetter for this linked list.
	...
	private static class LinkedElementsGetter implements ElementsGetter {
		...
		/**
		 * Creates new ElementsGetter specific for the LinkedListIndexedCollection.
		 * 
		...
		/**
		 * Determines if there are more elements in the linked list to be accessed.
		 * 
		...
		/**
		 * Returns the next element in the linked list if there is one.
		 * 
		 * @return the next object in the linked list that has not yet been accessed.
